/* Implementation of Fixed Point Arithmetic Operations
Floating pt operations are done by simulating using
17.14 (P.Q) Fixed point number representations,
where P are digits before decimal p & Q are after decimal pt
...
//Custome nested FP operations
#define DIV_INT_INT(m, n) CONVERT_INT_FP(m) / (n)
